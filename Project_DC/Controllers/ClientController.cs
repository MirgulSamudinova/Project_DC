...
namespace Project_DC.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FIO,DateOfBirth,HealthData")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FIO,DateOfBirth,HealthData")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
